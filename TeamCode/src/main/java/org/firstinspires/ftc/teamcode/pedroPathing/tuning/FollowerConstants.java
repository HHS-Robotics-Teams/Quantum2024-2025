...
public class FollowerConstants {
    ...
    private static double xMovement = 69.5562;
    private static double yMovement = 48.1767;
    ...
    public static double mass = 9.616158;
    ...
    public static double forwardZeroPowerAcceleration = -29.6952;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -66.7003;
