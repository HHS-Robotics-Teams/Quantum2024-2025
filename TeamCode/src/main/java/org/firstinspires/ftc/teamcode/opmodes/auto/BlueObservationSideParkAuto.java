...
public class BlueObservationSideParkAuto extends OpMode {
    ...
    private Path park = new Path(new BezierCurve(blueObservationStartPose,blueObservationPark));
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose((robotWidth/2),(48+(robotHeight/2)),0));
    }
