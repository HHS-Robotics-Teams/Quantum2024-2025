...
public class TwoWheelLocalizer extends Localizer { // todo: make two wheel odo work
    ...
    public static double FORWARD_TICKS_TO_INCHES = 0.0007;
    public static double STRAFE_TICKS_TO_INCHES = 0.0007;
    ...
    public TwoWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        forwardEncoderPose = new Pose(-8,1.5, 0);
        strafeEncoderPose = new Pose(2, 3.25, Math.toRadians(90));
